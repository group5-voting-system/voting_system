...
//       try {
//         await axios.post("http://localhost:5000/api/chatuser", {
//           message: inputMessage,
//         });
//         // يمكنك إضافة رد من البوت هنا إذا كنت ترغب في ذلك
//       } catch (error) {
...
//                     message.sender === "user" ? "bg-green-100" : "bg-gray-200"
//                   }`}
//                 >
//                   {message.text}
//                 </span>
...
//       try {
//         await axios.post("http://localhost:5000/api/chatuser", {
//           message: inputMessage, // إرسال الرسالة إلى الـ backend
//         });
//       } catch (error) {
//         console.error("Error sending message:", error);
//       }

//       setInputMessage(""); // مسح الحقل بعد إرسال الرسالة
//     }
//   };

...
const ServiceForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      let response;
      if (formType === 'debate') {
        response = await axios.post('http://localhost:5000/api/debates', debateFormData);
        Swal.fire({
          title: 'تم إرسال طلبك!',
        ...
        response = await axios.post('http://localhost:5000/api/submit-advertisement', adFormData);
        Swal.fire({
          title: 'تم إرسال طلبك!',
    ...
    <form onSubmit={handleSubmit} className="max-w-md mx-auto mt-10 p-6 bg-white rounded-lg shadow-xl" style={{ direction: 'rtl' }}>
      <div className="mb-6">
        <div className="relative w-full h-12 rounded-full bg-gray-200 cursor-pointer" onClick={toggleFormType}>
          <div className={`absolute top-0 right-0 w-1/2 h-full bg-blue-500 rounded-full transition-transform duration-300 ease-in-out ${formType === 'advertisement' ? 'transform translate-x-full' : ''}`}></div>
          <div className="absolute top-0 right-0 w-full h-full flex items-center justify-around text-sm font-bold">
            <span className={formType === 'debate' ? 'text-white' : 'text-gray-700'}>طلب مناظرة</span>
      ...
      {formType === 'debate' ? (
        <>
          <div className="mb-4">
            <label className="block text-gray-700 text-sm font-bold mb-2" htmlFor="DATE_OF_DEBATE">
              تاريخ المناظرة
            </label>
            <input
              type="date"
          ...
          <div className="mb-4">
            <label className="block text-gray-700 text-sm font-bold mb-2" htmlFor="FIRST_CANDIDATE">
              المرشح الأول
            </label>
            <input
              type="text"
          ...
          <div className="mb-4">
            <label className="block text-gray-700 text-sm font-bold mb-2" htmlFor="FIRST_CANDIDATE_LIST">
              قائمة المرشح الأول
            </label>
            <input
              type="text"
          ...
          <div className="mb-4">
            <label className="block text-gray-700 text-sm font-bold mb-2" htmlFor="SECOND_CANDIDATE">
              المرشح الثاني
            </label>
            <input
              type="text"
          ...
          <div className="mb-4">
            <label className="block text-gray-700 text-sm font-bold mb-2" htmlFor="SECOND_CANDIDATE_LIST">
              قائمة المرشح الثاني
            </label>
            <input
              type="text"
          ...
          <div className="mb-4">
            <label className="block text-gray-700 text-sm font-bold mb-2" htmlFor="ZOOM_LINK">
              رابط زوم
            </label>
            <textarea
              id="ZOOM_LINK"

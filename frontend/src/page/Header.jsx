    ...
    <header className="relative overflow-hidden bg-transparent h-16">
      ...
      <div className="absolute inset-0 z-0">
        <div className="animate-slide-rtl flex h-full">
          {[0, 1].map((index) => (
            <div key={index} className="flex-none w-full h-full flex flex-col relative">
              ...
              <div className="absolute top-[1.2rem] left-[0.2rem] w-7 h-7 text-white">
                <svg viewBox="0 0 51 48" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path fill="currentColor" d="M25.5 0L31.4019 18.3647H50.7275L35.1628 29.7205L41.0647 48.0853L25.5 36.7295L9.93534 48.0853L15.8372 29.7205L0.272499 18.3647H19.5981L25.5 0Z" />
                </svg>
              </div>
            </div>
          ))}
      ...
      <nav className="relative z-20 container mx-auto px-4 h-full">
        <ul className="flex justify-center items-center space-x-6 rtl:space-x-reverse h-full">
          <li>
            <Link to="" className="text-white hover:text-jordan-red transition duration-300 text-lg font-bold">
              صوت
            </Link>
          </li>
          <li>
            <Link to="" className="text-white hover:text-jordan-red transition duration-300 text-lg">
              قدم طلب ترشيح
            </Link>
          </li>
          <li>
